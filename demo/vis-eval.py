...
if __name__ == "__main__":
    ...
    parser.add_argument('--demo', action='store_true', help='whether to generate demo')
    parser.add_argument('--skip_2d', action='store_true', help='whether to skip 2D pose estimation')
    ...
    output_dir = './demo/output/hrnet-poseformer/' + video_name + '/'
    if not args.skip_2d:
      get_pose2D(video_path, output_dir)
      start_time = time.time()
    get_pose3D(video_path, output_dir)
    elapsed_time = time.time() - start_time
    print(f'3D pose reconstruction took {elapsed_time:.2f} seconds')
    if args.demo:
